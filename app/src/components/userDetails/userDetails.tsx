...
import ShareBracket from '../../assets/svg/ShareBracket';
    ...
    return (
        <aside className="aside">
            ...
            <div className="aside__container">
                <h1 className="aside__container--h1"> Jan Kowalski </h1>
                <h2 className="aside__container--h2"> Rzeszów, Podkarpackie, Polska </h2>
                ...
                <h2 className="aside__container--h2"> Informacje </h2>
                {infoItems.map(({ id, name, value }) => (
                    <div key={id} className="aside__container--item">
                        {name}
                        <span className="aside__container--item--value">
                            {value} {name === "Średnia" && <SingleStar />}</span>
                    </div>
                ))}

                <h2 className="aside__container--h2"> Kontakt </h2>
                <div className="aside__container--item">
                    Telefon 
                    <span className="aside__container--item--value"> 111 222 333</span>
                </div>
                <div className="aside__container--item">
                    Email 
                    <span className="aside__container--item--value"> nazwa@host.com</span>
                </div>
                ...
                <h2 className="aside__container--h2"> O mnie </h2>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores officiis nisi, sint quia ea inventore soluta voluptas obcaecati aliquam provident velit sit illum qui similique quas praesentium quisquam eaque libero.
            </div>
        </aside>
    );
}
